# Generated by Django 3.0.2 on 2020-02-01 20:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('projects', models.IntegerField(default=50, null=True)),
                ('workExperience', models.IntegerField(default=50, null=True)),
                ('certifications', models.IntegerField(default=50, null=True)),
